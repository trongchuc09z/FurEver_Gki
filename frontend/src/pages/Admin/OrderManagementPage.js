...
                    {/* === KẾT THÚC THÔNG TIN VẬT NUÔI === */}
                    ...
                    <div className="form-group">
                        ...
                        >
                            ...
                            <option value="ready-for-pickup">Chờ nhận tại cửa hàng</option>
                        </select>
                    </div>
...
const OrderManagementPage = () => {
    ...
    const formatDate = (dateString) => new Date(dateString).toLocaleDateString('vi-VN');
     const getPetId = (order) => {
        if (!order) return null;
        const id = typeof order.pet === 'object' ? order.pet?._id : order.pet;
        return id ? id.toString() : null;
    };
    const getShortPetId = (order) => {
        const id = getPetId(order);
                        ...
                        displayOrders.map((order) => (
                            <tr key={order._id}>
                                ...
                                <td className="pet-column">
                                 ...
                                 <td><code>{getPetId(order) || 'N/A'}</code></td>
